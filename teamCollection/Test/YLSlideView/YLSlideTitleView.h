...
static float const YLSildeTitleViewHeight = 40;
...
@property (nonatomic,copy) YLSlideTitleViewScrollBlock slideTitleViewScrollBlock;
@property (nonatomic,copy) YLSlideTitleViewClickButtonBlock slideTitleViewClickButtonBlock;
@property (nonatomic,copy) YLSlideViewWillScrollEndBlock slideViewWillScrollEndBlock;
