...
- (void)loadCustomViewWithTotal:(NSInteger)totalStar
{
    ...
    for (int i =0 ; i<totalStar; i++) {
        ...
        imageView.image = [UIImage imageNamed:@"b27_icon_star_gray"];
...
- (void)setCommentPoint:(CGFloat)commentPoint
{
    ...
    for (int j = 0; j< fullNumber; j++) {
        ...
        starImageView.image = [UIImage imageNamed:@"b27_icon_star_yellow"];
    ...
    if (part > 0) {
        ...
        partImage.image = [UIImage imageNamed:@"b27_icon_star_yellow"];
