...
- (void)initialization
{
    ...
    _currentPageDotColor = [UIColor colorWithRed:41/255.0 green:180/255.0 blue:237/255.0 alpha:1.0];
    _pageDotColor = [UIColor colorWithRed:213/255.0 green:213/255.0 blue:216/255.0 alpha:1.0];
...
- (void)setupPageControl
{
    ...
    switch (self.pageControlStyle) {
        ...
        case SDCycleScrollViewPageContolStyleClassic:
        {
            ...
            pageControl.numberOfPages = self.imagePathsGroup.count;
            pageControl.currentPageIndicatorTintColor = [UIColor colorWithRed:41/255.0 green:180/255.0 blue:237/255.0 alpha:1.0];
            
            _currentPageDotColor = [UIColor colorWithRed:41/255.0 green:180/255.0 blue:237/255.0 alpha:1.0];
            _pageDotColor = [UIColor colorWithRed:213/255.0 green:213/255.0 blue:216/255.0 alpha:1.0];
            
            pageControl.pageIndicatorTintColor = [UIColor colorWithRed:213/255.0 green:213/255.0 blue:216/255.0 alpha:1.0];
            pageControl.userInteractionEnabled = NO;
            pageControl.currentPage = indexOnPageControl;
            [self addSubview:pageControl];
            _pageControl = pageControl;
