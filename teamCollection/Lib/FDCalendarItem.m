...
- (UILabel *)dayLabel {
    if (!_dayLabel) {
        ...
        _dayLabel.layer.cornerRadius=10;
...
-(UIView*)pointView{
    ...
    if (!_pointView) {
        _pointView = [[UIView alloc] initWithFrame:CGRectMake(0, 70, 6, 6)];
        _pointView.layer.cornerRadius=3;
        _pointView.layer.masksToBounds=YES;
        _pointView.center = CGPointMake(self.bounds.size.width / 2, 40);
    ...
    if (indexPath.row < firstWeekday) {    // 小于这个月的第一天
        ...
        if (day == [[NSCalendar currentCalendar] component:NSCalendarUnitDay fromDate:self.date]) {
            ...
            if (day == [[NSCalendar currentCalendar] component:NSCalendarUnitDay fromDate:[NSDate date]]) {
                cell.dayLabel.textColor = [UIColor colorWithRed:41/255.0 green:180/255.0 blue:237/255.0 alpha:1.0];
                cell.dayLabel.backgroundColor = [UIColor clearColor];
                cell.dayLabel.textColor = [UIColor colorWithRed:41/255.0 green:180/255.0 blue:237/255.0 alpha:1.0];
                
            }else{
                cell.dayLabel.backgroundColor = [UIColor colorWithRed:41/255.0 green:180/255.0 blue:237/255.0 alpha:1.0];
                cell.dayLabel.textColor = [UIColor whiteColor];
                cell.pointView.backgroundColor=[UIColor colorWithRed:41/255.0 green:180/255.0 blue:237/255.0 alpha:1.0];
            }
        }
