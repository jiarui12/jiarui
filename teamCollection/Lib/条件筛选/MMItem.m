...
- (NSString *)findSubTitleBySelectedPath:(MMSelectedPath *)selectedPath {
    if (selectedPath.thirdPath != -1) {
        return self.childrenNodes[selectedPath.firstPath].childrenNodes[selectedPath.secondPath].childrenNodes[selectedPath.thirdPath].subTitle;
    }
    if (selectedPath.secondPath != -1) {
        return [self.childrenNodes[selectedPath.firstPath].childrenNodes[selectedPath.secondPath] subTitle];
    }
    return [self.childrenNodes[selectedPath.firstPath] subTitle];
}
