...
- (void)popupViewFromSourceFrame:(CGRect)frame completion:(void (^ __nullable)(void))completion {
    ...
    CGFloat resultHeight = MIN(maxHeight, self.item.childrenNodes.count * 49*kScreenWidth/375);
    ...
    self.mainTableView.backgroundColor=[UIColor colorWithHexString:@"F2F2F4"];
