...
static  NSString *titleSelectedColor = @"29B4ED";
...
static const NSTimeInterval AnimationDuration= 0;
...
/* color */
static  NSString *SelectedBGColor = @"E7E7E7";
static  NSString *UnselectedBGColor = @"F2F2F2";
//MMComBoBoxView
