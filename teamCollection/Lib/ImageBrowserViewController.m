...
-(UIPageControl *)pageControl{
    if (_pageControl==nil) {
        ...
        _pageControl.currentPageIndicatorTintColor = [UIColor colorWithRed:153/255.0 green:153/255.0 blue:153/255.0 alpha:1];
        
       
        
        _pageControl.pageIndicatorTintColor = [UIColor colorWithRed:235/255.0 green:235/255.0 blue:235/255.0 alpha:1];
