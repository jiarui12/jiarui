...
- (void)setTitleColor:(UIColor *)titleColor {
    ...
    for (int i = 0; i < _btnCount; i++) {
        ...
        [btn setTitleColor:[UIColor colorWithRed:1 green:1 blue:1 alpha:0.73] forState:UIControlStateNormal];
        [btn setTitleColor:[UIColor colorWithRed:1 green:1 blue:1 alpha:0.73] forState:UIControlStateHighlighted];
    }
...
- (void)createUI
{
    ...
    // 指示视图
    _indicatorView = [[UIView alloc] initWithFrame:CGRectMake(0, btnHeight-1, _btnWidth, 1)];
    ...
    for (int i = 0; i < _btnCount; i++)
    {
        ...
        btn.titleLabel.font = [UIFont boldSystemFontOfSize:16*WIDTH/375];
    ...
    [UIView animateWithDuration:0.25f animations:^{
        ...
        switch (index) {
            case 0:
                 ...
                 _indicatorView.frame = CGRectMake(_btnWidth * index, btnHeight-1, _btnWidth, _indicatorView.frame.size.height);
        ...
        _indicatorView.frame = CGRectMake(_btnWidth * index, btnHeight-1, _indicatorView.frame.size.width, _indicatorView.frame.size.height);
...
- (void)selectedBegan
{
    ...
    [_currentBtn setTitleColor:[UIColor colorWithRed:1 green:1 blue:1 alpha:0.73] forState:UIControlStateNormal];
}
