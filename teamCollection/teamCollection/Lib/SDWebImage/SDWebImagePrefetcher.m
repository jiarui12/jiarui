...
- (void)reportStatus
{
    ...
    NSLog(@"Finished prefetching (%lu successful, %lu skipped, timeElasped %.2f)",
          total - _skippedCount, (unsigned long)_skippedCount, CFAbsoluteTimeGetCurrent() - _startedTime);
}
...
- (void)prefetchURLs:(NSArray *)urls
{
    ...
    long listCount = [self.prefetchURLs count];
