...
-(void)loadData{
    ...
    [manager GET:url parameters:parameters progress:^(NSProgress * _Nonnull downloadProgress) {
        ...
        [self.iconImage setImageWithURL:[NSURL URLWithString:self.icon]placeholderImage:[UIImage imageNamed:@"man_default_icon"]];
        ...
        [self.rightIconView setImageWithURL:[NSURL URLWithString:self.rightIcon]placeholderImage:[UIImage imageNamed:@"man_default_icon"]];
        ...
        [self.videoImageView setImageWithURL:[NSURL URLWithString:self.videoImage]placeholderImage:[UIImage imageNamed:@"material_default_pic_2"]];
        ...
        _size = [str sizeWithFont:_Label.font constrainedToSize:CGSizeMake(_Label.frame.size.width, MAXFLOAT) lineBreakMode:NSLineBreakByWordWrapping];
        ...
        for (int i =0; i<self.pListArr.count; i++) {
            ...
            [_pListIcon setImageWithURL:[NSURL URLWithString:self.pListArr[i]]placeholderImage:[UIImage imageNamed:@"man_default_icon"]];
