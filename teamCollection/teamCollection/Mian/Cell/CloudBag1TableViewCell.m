...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _headImage1=[[UIImageView alloc]initWithFrame:CGRectMake(self.contentView.frame.size.width/3*0+20, 30, (self.contentView.frame.size.width-5*2*10)/4, (self.contentView.frame.size.width-5*2*10)/4)];
        _headImage1.layer.cornerRadius=_headImage1.frame.size.width/2;
        _headImage1.clipsToBounds=YES;
        
        _label1=[[UILabel alloc]init];
        _label1.frame=CGRectMake(self.contentView.frame.size.width/3*0+20, 100, (self.contentView.frame.size.width-5*2*10)/4,20 );
        _label1.textAlignment=NSTextAlignmentCenter;
        _label1.font=[UIFont systemFontOfSize:14];
        [self.view1 addSubview:_label1];
        
         _label2=[[UILabel alloc]init];
        _label2.frame=CGRectMake(self.contentView.frame.size.width/3*1+20, 100, (self.contentView.frame.size.width-5*2*10)/4,20 );
        _label2.textAlignment=NSTextAlignmentCenter;
        _label2.font=[UIFont systemFontOfSize:14];
        [self.view1 addSubview:_label2];

         _label3=[[UILabel alloc]init];
        _label3.frame=CGRectMake(self.contentView.frame.size.width/3*2+10, 100, (self.contentView.frame.size.width-5*2*10)/4+20,20 );
        ...
        _headImage2=[[UIImageView alloc]initWithFrame:CGRectMake(self.contentView.frame.size.width/3*1+20, 30, (self.contentView.frame.size.width-5*2*10)/4, (self.contentView.frame.size.width-5*2*10)/4)];
        ...
        _headImage3=[[UIImageView alloc]initWithFrame:CGRectMake(self.contentView.frame.size.width/3*2+20, 30, (self.contentView.frame.size.width-5*2*10)/4, (self.contentView.frame.size.width-5*2*10)/4)];
        ...
        _headImage4=[[UIImageView alloc]initWithFrame:CGRectMake(self.contentView.frame.size.width/2-((self.contentView.frame.size.width-5*2*10)/3/2), 30, (self.contentView.frame.size.width-5*2*10)/4, (self.contentView.frame.size.width-5*2*10)/4)];
        _headImage4.layer.cornerRadius=_headImage4.frame.size.width/2;
        _headImage4.clipsToBounds=YES;
        
        self.label4=[[UILabel alloc]initWithFrame:CGRectMake(self.contentView.frame.size.width/2-((self.contentView.frame.size.width-5*2*10)/3/2), 100, (self.contentView.frame.size.width-5*2*10)/3, 20)];
        ...
        [scroll setContentSize:CGSizeMake(self.contentView.frame.size.width*2, 120)];
