...
- (UIView *)topTabView{
    if (!_topTabView){
        ...
        if (_isTranslucent) {
            ...
            backView.barTintColor=[UIColor whiteColor];
            [_topTabView addSubview:backView];
        }else{
            _topTabView.backgroundColor = [UIColor colorWithRed:41/255.0 green:180/255.0 blue:237/255.0 alpha:1.0];
        }
        if (self.leftButton) {
...
//            titleButton.backgroundColor=[UIColor redColor];
            ...
            if (token.length<8) {
                if (i>0) {
                    ...
                    [titleButton setTitleColor:[UIColor colorWithRed:242/255.0 green:242/255.0 blue:242/255.0 alpha:1.0] forState:UIControlStateNormal];
                    _unselectedColor=[UIColor colorWithRed:175/255.0 green:175/255.0 blue:175/255.0 alpha:1.0];
                }
            }
...
- (UIScrollView *)scrollView{
    if (!_scrollView) {
        ...
        _scrollView.contentSize = CGSizeMake(_selfFrame.size.width * _viewControllers.count, 0);
